...
<div class="info-grid">
  ...
  <div class="info-box" data-box-id="box-1">
  ...
  <div class="info-box" data-box-id="box-2">
  ...
  <div class="info-box" data-box-id="box-3">
  ...
  <div class="info-box" data-box-id="box-4">
  ...
  <div class="info-box" data-box-id="box-5">
  ...
  <div class="info-box" data-box-id="box-6">
  ...
  <div class="info-box" data-box-id="box-7">
  ...
  <div class="info-box" data-box-id="box-8">
  ...
  <div class="info-box" data-box-id="box-9">
  ...
  <div class="info-box" data-box-id="box-10">
  ...
  <div class="info-box" data-box-id="box-11">
  ...
  <div class="info-box" data-box-id="box-12">
...
function displayRegionalChart(data) {
  ...
  var regions = data.map(function(item) { return item.region; });
  var totalDisruptions = data.map(function(item) { return item.total; });
  var highImpactDisruptions = data.map(function(item) { return item.high_impact; });
  ...
  var layout = {
    ...
    yaxis: { title: 'Count', titlefont: { size: 11 }, tickfont: { size: 10 } },
    autosize: true,
